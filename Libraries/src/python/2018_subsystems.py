...
from drive_tests import advanced_drive_sim
...
def main():
  ...
  #wrist.run_pid_test([20, 0.0,0.0],numpy.matrix([[0.0],[0]]), numpy.matrix([[90.0],[0]]), True, True, 400)
  ...
  drive_gear_ratio = 50.0 /34.0#5.30#(60.0 / 12.0) * (34.0 / 24.0) * (34.0/ 32.0)
  distribution_radius = 0.45
  mass = 154.0 * 0.454
  j = 6.0#distribution_radius * mass
  ...
  drivetrain = drive(0.005, "drivetrain", 3.0, 2.0, 131.0, 2.7, 2.41, 5330 * 2.0 * math.pi / 60.0,
                 drive_gear_ratio, j, 2.0 * 0.0254, 32.0 * 0.0254 * 0.5, (120.0) * 0.454)
  ...
  #advanced_drive = advanced_drive_sim(0.005, "drivetrain", 4.0, 3.0, 89.0, 3.0, 1.41, 5840 * 2.0 * math.pi / 60.0,
   #             drive_gear_ratio, j, 3.0 * 0.0254, 28.0 * 0.0254 * 0.5, 154.0 * 0.454)
  #print(advanced_drive.A_d)
