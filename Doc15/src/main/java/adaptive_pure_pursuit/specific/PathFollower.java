...
import adaptive_pure_pursuit.heading.AdaptivePurePursuitController;
import adaptive_pure_pursuit.heading.Lookahead;
import adaptive_pure_pursuit.heading.Path;
import adaptive_pure_pursuit.motion.MotionProfileConstraints;
import adaptive_pure_pursuit.motion.MotionProfileGoal;
import adaptive_pure_pursuit.motion.MotionProfileGoal.CompletionBehavior;
import adaptive_pure_pursuit.motion.MotionState;
import adaptive_pure_pursuit.motion.ProfileFollower;
...
public class PathFollower {
    ...
    public synchronized Twist update(double t, RigidTransform pose, double displacement, double velocity) {
        ...
        mDebugOutput.pose_theta = pose.getRotation().angle();
