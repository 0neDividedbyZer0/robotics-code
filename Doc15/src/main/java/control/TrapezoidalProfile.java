 ...
 * Based on 1678 Trapezoidal Profile class. This essentially calculates profiles on the fly,
 * meaning you do not have to generate them newly each time. Furthermore, this can handle
 * truncated profiles (triangular profiles), nonzero velocity starting speeds and end speeds, 
 * and calculate time to end state.
 *
 */
public class TrapezoidalProfile {
	 ...
	 * 
	 * This is just calculus on a trapezoid to figure out where your point is. The time is relative from
	 * the original time of the point.
	 */
