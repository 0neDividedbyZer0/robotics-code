...
public class CollectVelocityData implements Action {
    private static final double kMaxPower = 0.45;
    ...
    public void update() {
        ...
        mVelocityData.add(new DriveCharacterization.VelocityDataPoint(
                6.0-((Constants.KV * Math.abs(Drive.getInstance().getLeftEncoderRate() + Drive.getInstance().getRightEncoderRate()) / 2.0) + 3.26), //convert velocity to radians per second
