...
public class TalonSRXFactory {
    ...
    public static TalonSRX createPermanentSlaveTalon(int id, int master) {
        final TalonSRX talon = createTalon(id, kSlaveConfiguration);
        talon.set(ControlMode.Follower, master);
        return talon;
    }
    
    public static TalonSRX createPermanentSlaveTalon(int id, IMotorController master) {
        final TalonSRX talon = createTalon(id, kSlaveConfiguration);
        talon.follow(master);
        return talon;
    }
