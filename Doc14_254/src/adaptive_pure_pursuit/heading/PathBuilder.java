...
public class PathBuilder {
    ...
    static class Arc {
        ...
        private static Translation intersect(Line l1, Line l2) {
            final RigidTransform lineA = new RigidTransform(new Rotation(l1.slope, true).normal(),l1.end);
            final RigidTransform lineB = new RigidTransform(new Rotation(l2.slope, true).normal(),l2.start);
