...
public class PathController {
    ...
    double offset, encoder_tick_count;
    ...
    public PathController(Trajectory traj) {
     ...
     */
    public void configureEncoder(double initial_position, double wheel_diameter) {
     ...
     */
    public void reset() {
        last_error = 0; segment = 0; tailTime = 0;
    }
    ...
    public double calculate(double measurement) {
    	double distance_covered = measurement - offset;
